...
object Plotly extends js.Object {
  def newPlot(gd: String | HTMLElement,
  ...
  def react(gd: String | HTMLElement,
            data: js.UndefOr[js.Array[js.Dictionary[Any]]] = js.undefined,
            layout: js.UndefOr[js.Dictionary[Any]] = js.undefined,
            options: js.UndefOr[js.Dictionary[Any]] = js.undefined): Promise[GraphDiv] = js.native
  def plot(gd: String | HTMLElement,
           data: js.UndefOr[js.Array[js.Dictionary[Any]]] = js.undefined,
           layout: js.UndefOr[js.Dictionary[Any]] = js.undefined,
           options: js.UndefOr[js.Dictionary[Any]] = js.undefined): Promise[GraphDiv] = js.native
  def restyle(gd: String | HTMLElement,
  ...
  def moveTraces(gd: String | GraphDiv,
                 currentIndices: Int | js.Array[Int],
                 newIndices: js.UndefOr[Int | js.Array[Int]] = js.undefined): Promise[GraphDiv] = js.native
  def extendTraces(gd: String | GraphDiv,
                   update: Int | js.Array[Int],
                   indices: Int | js.Array[Int] /*, maxPoints*/ ): Promise[GraphDiv] = js.native
  def prependTraces(gd: String | GraphDiv,
                    update: Int | js.Array[Int],
                    indices: Int | js.Array[Int] /*, maxPoints*/ ): Promise[GraphDiv] = js.native
  ...
  @js.native
  @JSName("d3")
  val d3: js.Dynamic = js.native //org.singlespaced.d3js.d3
